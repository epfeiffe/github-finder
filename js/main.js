$(document).ready(function() {
  $('#searchUser').on('keyup', function(e) {
    ...
    $.ajax({
      ...
      data: {
        client_id: '709655e736e3a60e7ab0', // use my client info, otherwise can only make 50 request per month
        client_secret: '540b128d3f77bbf5eddeca40ce4eed1531654484'
      }
    }).done(function(user) {
      $.ajax({
        url: 'https://api.github.com/users/' + username + '/repos',
        data: {
          client_id: '709655e736e3a60e7ab0',
          client_secret: '540b128d3f77bbf5eddeca40ce4eed1531654484',
          sort: 'created: asc',
          per_page: 5
        }
